...
* 您了解 https://prometheus.io/docs/prometheus/latest/querying/basics/["Prometheus 查询的语法"^]。
* 您也可以观看以下视频： https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=e3a75bc1-47a2-44b9-a84d-b0b9011dc2d1["视频：在StorageGRID 11.8.中使用指标创建自定义警报"^]。
+
