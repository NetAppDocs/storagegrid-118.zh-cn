...
如果您的StorageGRID部署包含多个管理节点、则主管理节点是警报通知、AutoSupport软件包、SNMP陷阱和通知以及原有警报通知的首选发送方。如果主管理节点不可用、则其他管理节点会临时发送通知。请参见 link:../primer/what-admin-node-is.html["什么是管理节点？"]。
