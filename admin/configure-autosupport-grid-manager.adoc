...
默认情况下、StorageGRID系统配置为每小时或在发生重要警报或其他重大系统事件时向技术支持发送一次AutoSupport软件包。
...
* https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/configuring-snmp-settings-for-bmc.html["配置BMC的SNMP设置"^] 对于SG6000-CN控制器或SG100和SG1000服务设备
